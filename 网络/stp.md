...
```
+-----------------+ +-----------------+ | S1 (根桥) |--------| PC4 172.17.10.27| | 优先级:24577 | 干道3 +-----------------+ | MAC:000A00333333| +--------+--------+ | 干道1 | +-----------------+ | +-----------------+ | S3 |------+------| S2 | | 优先级:32769 | 干道2 | 优先级:32769 | | MAC:000A00222222| | MAC:000A00111111| +-----------------+ +--------+--------+ | +----------------------+----------------------+ | | | +-------v-------+ +-------v-------+ +-------v-------+ | PC1 | | PC2 | | PC3 | | 172.17.10.21 | | 172.17.10.22 | | 172.17.10.23 | +---------------+ +---------------+ +---------------+
```